    ...
    <div className="w-full flex justify-center">
      <main className="md:mt-[100px] w-full md:w-[700px] py-8 px-5 space-y-4">
        <div className="text-text md:w-4/5 space-y-2">
          ...
          <p>
            This website allows users to download Spotify playlists, albums, and
            tracks easily. When downloading playlist the website returns a ZIP
            file with all the tracks. Individual tracks are served with
            metadata.
          </p>
          <h2 className="text-2xl font-semibold mb-3">How do I use it?</h2>
          <p>
            Simply press on the three dots in a Spotify playlist, album, or
            track, share it, copy the link, then paste the link in the input
            dialog on the{' '}
          ...
          <p>
            The website uses the Spotify API to get data from playlists, albums and
